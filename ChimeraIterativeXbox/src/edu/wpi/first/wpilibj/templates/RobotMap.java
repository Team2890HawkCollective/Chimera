...
//    public static final int RAISE_BRIDGE_LIMIT_SWITCH_PORT = 3;
    ...
    public static final int GREEN_XBOX_CONTROLLER = 1;
    public static final int BLUE_XBOX_CONTROLLER = 2;
    ...
    public static final int BUTTON_CONVEYOR_BELT_LOWER = 2;
...
//    public static final int BUTTON_LOWER_ANGLE = 10;
    ...
    public static Jaguar leftDriveMotor = new Jaguar(DIGITAL_SIDE_CAR, LEFT_MOTOR_PORT);
    public static Jaguar rightDriveMotor = new Jaguar(DIGITAL_SIDE_CAR, RIGHT_MOTOR_PORT);
    public static Jaguar pitcherBottomMotor = new Jaguar(DIGITAL_SIDE_CAR, BOTTOM_SHOOTER_JAGUAR_PORT);
    public static Jaguar pitcherTopMotor = new Jaguar(DIGITAL_SIDE_CAR, TOP_SHOOTER_JAGUAR_PORT);
    public static Jaguar angleMotor = new Jaguar(DIGITAL_SIDE_CAR, ANGLE_MOTOR_PORT);
    public static Jaguar lowerBridgeMotor = new Jaguar(DIGITAL_SIDE_CAR, LOWER_BRIDGE_MOTOR_PORT);
    public static Jaguar conveyorBeltMotor = new Jaguar(DIGITAL_SIDE_CAR, CONVEYOR_MOTOR_PORT);
    ...
    public static XboxControllers greenXboxController= new XboxControllers(GREEN_XBOX_CONTROLLER);
    public static XboxControllers blueXboxController= new XboxControllers(BLUE_XBOX_CONTROLLER);
    
    public static RobotDrive robotDrive = new RobotDrive(leftDriveMotor, rightDriveMotor);
    
//    public static DigitalInput lowerBridgeLimitSwitch = new DigitalInput(DIGITAL_SIDE_CAR, LOWER_BRIDGE_LIMIT_SWITCH_PORT);
//    public static DigitalInput raiseBridgeLimitSwitch = new DigitalInput(DIGITAL_SIDE_CAR, RAISE_BRIDGE_LIMIT_SWITCH_PORT);
