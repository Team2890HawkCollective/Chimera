...
//            robotDrive.tankDrive(leftDriveJoystick, rightDriveJoystick);
           robotDrive.tankDrive(greenXboxController.getLeftStickY(), greenXboxController.getRightStickY());
//           robotDrive.tankDrive(greenXboxController.getRightStickY(), greenXboxController.getLeftStickY());
//        }

//        if (assistingJoystick.getRawButton(BUTTON_CONVEYOR_BELT_RAISE) == true) {
//            commandBase.initCommand(COMMAND_NUMBER_PICK_UP_BALL);
//            commandBase.executeCommand(COMMAND_NUMBER_PICK_UP_BALL);
//        }
        
        if (blueXboxController.getX() == true) {
            commandBase.initCommand(COMMAND_NUMBER_PICK_UP_BALL);
            commandBase.executeCommand(COMMAND_NUMBER_PICK_UP_BALL);
        }

//        if (assistingJoystick.getRawButton(BUTTON_CONVEYOR_BELT_LOWER) == true) {
//            commandBase.endCommand(COMMAND_NUMBER_PICK_UP_BALL);
//        }
        
        if (blueXboxController.getB() == true) {
            commandBase.endCommand(COMMAND_NUMBER_PICK_UP_BALL);
        }
...
//        }
        ...
        if (blueXboxController.getX() == false && blueXboxController.getB() == false) {
            commandBase.defaultCommand(COMMAND_NUMBER_PICK_UP_BALL);
        }
...
//        }
        ...
        if (blueXboxController.getTriggerAxis() == -1.0) {
            commandBase.executeCommand(COMMAND_NUMBER_FIRE);
        }
...
//        }
        ...
        if (blueXboxController.getLeftStickY() > 0.1 || blueXboxController.getLeftStickY() < -0.1) {
            commandBase.initCommand(COMMAND_NUMBER_LOWER_BRIDGE);
        } else {
            commandBase.defaultCommand(COMMAND_NUMBER_LOWER_BRIDGE);
        }
...
//        }
        ...
        if (blueXboxController.getLeftBumper() == true) {
            pitcherSlowSpeed = true;
            hawkSmartDashboard.putString(pitcherSpeed, new String("Slow Speed"));
        }
...
//        }
        ...
        if (blueXboxController.getRightBumper() == true) {
            pitcherSlowSpeed = false;
            hawkSmartDashboard.putString(pitcherSpeed, new String("Fast Speed"));
        }
